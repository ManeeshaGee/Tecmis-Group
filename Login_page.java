...
public class Login_page extends javax.swing.JFrame {
            ...
            try{
                ...
                if(rs.next()){
                    ...
                    if(des.equals("student")){
                        TOMainFrame mf = new TOMainFrame(name);
                        mf.setVisible(true);
                        this.dispose();
                    }
                    else{
                        TOMainFrame mf = new TOMainFrame(name,title);
                        mf.setVisible(true);
                        this.dispose();
                    }
    ...
    // Check if the pressed key is Enter (key code 10 for Enter)
    if(evt.getKeyCode() == KeyEvent.VK_ENTER) {
        // Call the action performed method to execute the same functionality as clicked
